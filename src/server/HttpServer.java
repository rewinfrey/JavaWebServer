...
//  public void register(String uri, Responder responder)
//  {
//    router.register(url, responder);
//  }
...
//        public void run()
//        {
//          Map<String, Object> request = HttpResponseParser.parse(clientSocket.getInputStream());
//          Map<String, Object> responseMap = router.respond(request);
//          // response => {"status" => 200, "body" => "<html>....</html>"}
//          HttpResponse.from(responseMap).write(clientSocket.getOutputStream());
//        }
//      }).start();
    }
  }
